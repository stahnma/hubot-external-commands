...
//
// Author:
//   Copied from https://github.com/hubotio/hubot-help/blob/master/src/help.js
//   sarameisburger
//
// Category: workflow
...
module.exports = (robot) => {
  // if user calls "hubot help" privately message them the commands
  ...
  robot.respond(/help(?:\s+(.*))?$/i, (msg) => {
    ...
    if(replyInPrivate == true && msg.message.user.id) {
